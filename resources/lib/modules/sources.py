...
class Sources():
	...
	def collect_results(self):
		...
		# Load and add magneto providers
		self.load_magneto_providers()
		if self.magneto_providers and self.active_external:
			self.external_providers.extend(self.magneto_providers)
			self.external_args = (self.meta, self.external_providers, self.debrid_enabled, debrid_service, debrid_token, self.internal_scraper_names,
									self.prescrape_sources, self.progress_dialog, self.disabled_ext_ignored)
	...
	def load_magneto_providers(self):
		self.magneto_providers = self.magneto_provider_sources()
