...
years_movies = list(range(_current_year, 1899, -1))
years_tvshows = list(range(_current_year, 1941, -1))

decades_movies = [int(str(year)[:3] + '0') for year in range(_current_year, 1899, -10)]
