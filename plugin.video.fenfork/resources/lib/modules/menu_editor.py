...
default_path = 'plugin://plugin.video.fenfork'
...
class MenuEditor:
	def __init__(self, params):
		...
		else: self.menu_item = dict(parse_qsl(get_infolabel('ListItem.FileNameAndPath').replace('plugin://plugin.video.fenfork/?','')))
	...
	def shortcut_folder_browse_for_content(self):
		...
		self.menu_item = dict(parse_qsl(browsed_result['file'].replace('plugin://plugin.video.fenfork/?','')))
