...
destination_check = translate_path('special://home/addons/plugin.video.fenfork/')
...
def update_addon(new_version, action):
	...
	zip_name = 'plugin.video.fenfork-%s.zip' % new_version
	...
	shutil.rmtree(osPath.join(home_addons_dir, 'plugin.video.fenfork'))
